...
Display Y0,F0,X0,Z0,Xp0,Xg0,Xv0,E0,M0,Q0,D0,Sp0,Sg0,Td0,Tz0,Tm0,FF,Sf,tauz,taum;
...
Equation         eqpy(j)         composite factor agg. func.
                 ...
                 eqTm(i)         import tariff revenue funtion
                 eqXg(i)         government demand funtion

                 eqXv(i)         investment demand function
                 eqSp            production tax revenue function
